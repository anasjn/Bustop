...
public class MapsActivity extends AppCompatActivity
    ...
    //requestCode when the activity is trying to resolve the conection error with the Google Play Services
    ...
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        ...
        if (connectionResult.hasResolution()) {
            try {
                // Start an Activity that tries to resolve the error. Resolves an error by starting any intents requiring user interaction
        ...
        mMap.setInfoWindowAdapter(new GoogleMap.InfoWindowAdapter() {
            ...
            public View getInfoContents(Marker marker) {
                ...
                View infoWindow = getLayoutInflater().inflate(R.layout.custom_info,
                        (FrameLayout) findViewById(R.id.activity_map), false);
    ...
    private void showCurrentPlace() {
        ...
        if (mLocationPermissionGranted) {
            //TODO check the nearest bus stop
